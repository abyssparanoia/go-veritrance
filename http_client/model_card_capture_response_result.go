...
type NullableCardCaptureResponseResult struct {
	value *CardCaptureResponseResult
	isSet bool
}

func (v NullableCardCaptureResponseResult) Get() *CardCaptureResponseResult {
	return v.value
}

func (v *NullableCardCaptureResponseResult) Set(val *CardCaptureResponseResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCardCaptureResponseResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCardCaptureResponseResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardCaptureResponseResult(val *CardCaptureResponseResult) *NullableCardCaptureResponseResult {
	return &NullableCardCaptureResponseResult{value: val, isSet: true}
}

func (v NullableCardCaptureResponseResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardCaptureResponseResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
