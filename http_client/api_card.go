...
func (r ApiPaynowV2CancelCardinfoRequest) Body(body string) ApiPaynowV2CancelCardinfoRequest {
	r.body = &body
	return r
}
...
func (r ApiPaynowV2CaptureCardinfoRequest) Body(body string) ApiPaynowV2CaptureCardinfoRequest {
	r.body = &body
	return r
}
